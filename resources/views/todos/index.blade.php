...
<x-app-layout>
    ...
    <h2></h2>
    <form action="/todos" method="POST" style="width:500px;display: inline-block;background-color: #fdfbf8;padding: 20px 40px; box-shadow: 0px 0px 5px #716040; border-radius: 10px;box-sizing: border-box;margin:30px 30px 30px 100px;" class="container" >
        @csrf
        <div>
    ...
    <div  style="display: inline-block;background-color: #fdfbf8;padding: 20px 40px; box-shadow: 0px 0px 5px #716040; border-radius: 10px;box-sizing: border-box;margin:30px 30px 30px 100px;" class="container">
<table class="table">
            <thead>
                <tr>
